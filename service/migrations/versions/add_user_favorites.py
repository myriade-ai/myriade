...
Revises: add_is_favorite_field
Create Date: 2025-05-19 13:20:00.000000
...
down_revision: Union[str, None] = "add_is_favorite_field"
...
def upgrade() -> None:
    op.create_table(
        "user_favorite",
        sa.Column(
            "id", UUID(), server_default=sa.text("gen_random_uuid_v7()"), nullable=False
        ),
        sa.Column("user_id", sa.String(), nullable=False),
        sa.Column("query_id", UUID(), nullable=True),
        sa.Column("chart_id", UUID(), nullable=True),
        sa.Column(
            "createdAt", sa.DateTime(), server_default=sa.func.now(), nullable=False
        ),
        sa.Column(
            "updatedAt",
            sa.DateTime(),
