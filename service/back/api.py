...
def update_catalog_asset(asset_id: str):
    ...
    if "privacy" in data and asset.type == "COLUMN" and asset.column_facet:
        # Update privacy for column assets
        privacy_value = data["privacy"]
        if privacy_value:
            asset.column_facet.privacy = {"llm": privacy_value}
        else:
            asset.column_facet.privacy = None
