<template>
  <div
    class="grid gap-2 lg:grid-cols-[1fr_auto_auto_auto] items-center flex-shrink-0 p-4 border-b border-slate-200 bg-gradient-to-r from-slate-50 via-stone-50 to-slate-50"
  >
