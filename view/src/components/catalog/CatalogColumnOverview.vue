  ...
  <div class="space-y-4">
    <div class="space-y-2">
      <div class="flex items-center justify-between gap-2">
        ...
        <div v-if="asset && draft" class="flex items-center gap-2">
    ...
    <div class="space-y-2">
      <h3 class="text-sm font-medium text-muted-foreground">Privacy</h3>
      <Select :model-value="draft.privacy" @update:model-value="updatePrivacy" :disabled="isSaving">
...
function updatePrivacy(privacy: any) {
  emit('update:draft', { ...props.draft, privacy: String(privacy || 'Default') })
  emit('start-edit')
}
</script>
