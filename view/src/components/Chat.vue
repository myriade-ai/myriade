  ...
  <div>
    ...
    >
      <div class="flex flex-col w-full min-h-[calc(100vh-4rem)]">
        ...
        <div
          id="chat-input"
          class="w-full max-w-4xl border-gray-300 bottom-0 sticky z-10 mx-auto lg:px-2 px-0 pb-4"
        >
          <!-- Background overlay to prevent content showing underneath -->
          <div class="absolute inset-0 -mx-2 sm:-mx-4 lg:mx-0 bg-white"></div>
