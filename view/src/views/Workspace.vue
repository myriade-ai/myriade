<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="py-10">
      <h1 class="text-3xl font-bold leading-tight text-gray-900">Workspace</h1>
      ...
      <div v-else>
        ...
        <div class="mt-8">
          ...
          <div v-else class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="query in queries" :key="query.id" class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg font-medium text-gray-900 truncate">{{ query.title || 'Untitled Query' }}</h3>
                ...
                <div class="mt-4 flex justify-between">
                  ...
                  <button @click="unfavoriteQuery(query.id)" class="text-sm text-red-600 hover:text-red-500">
                    Remove
                  </button>
                </div>
              </div>
        ...
        <div class="mt-8">
          ...
          <div v-else class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="chart in charts" :key="chart.id" class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4 flex justify-between">
                  ...
                  <button @click="unfavoriteChart(chart.id)" class="text-sm text-red-600 hover:text-red-500">
                    Remove
                  </button>
                </div>
              </div>
